                ...
                {mode === 'join' ? (
                    <form action={async (formData) => {
                        ...
                        <div>
                            ...
                            <input name="companyCode" className="input" placeholder="Ex: ACME-1A2B" required disabled={loading} />
                    ...
                    <form action={async (formData) => {
                        ...
                        <div>
                            ...
                            <input name="companyName" className="input" placeholder="Minha Empresa S.A." required disabled={loading} />
                        </div>
                        <button className="btn btn-primary" type="submit" disabled={loading}>
